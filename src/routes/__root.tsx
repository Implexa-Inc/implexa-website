...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Implexa turns the workflows your team already runs in Claude into reusable, shareable, measurable skills. Capture once. Replay forever." },
