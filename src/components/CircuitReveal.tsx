...
export function CircuitReveal() {
  ...
  useEffect(() => {
    ...
    function renderWiring() {
      ...
      // Glow underlay
      wctx.lineCap = "round";
      wctx.strokeStyle = "rgba(16, 185, 129, 0.18)";
      wctx.lineWidth = 4;
      wctx.shadowColor = "rgba(16, 185, 129, 0.35)";
      wctx.shadowBlur = 10;
      ...
      // Crisp core line
      wctx.shadowBlur = 0;
      wctx.strokeStyle = "rgba(110, 231, 183, 0.5)";
      wctx.lineWidth = 1.25;
      for (const e of edges) {
        wctx.beginPath();
        wctx.moveTo(e.x1, e.y1);
      ...
      // Nodes
      wctx.fillStyle = "rgba(167, 243, 208, 0.55)";
      wctx.shadowColor = "rgba(16, 185, 129, 0.45)";
      wctx.shadowBlur = 8;
