...
export default async function SkillDetailPage(props: {
  ...
  // JSON-LD graph for this page. Composable with whatever the SkillScore
  // chip adds: that chip emits Review + AggregateRating, which we'll spread
  // into the same jsonLdGraph(...) call once both ship. For now: just the
  // SoftwareApplication + BreadcrumbList pair.
